...
let
  cfg = config.services.zigbee2mqtt2;
...
in
{
  ...
  options.services.zigbee2mqtt2 = {
    enable = lib.mkEnableOption "zigbee2mqtt2 service";

    package = lib.mkPackageOption pkgs "zigbee2mqtt" { };

    dataDir = lib.mkOption {
      description = "Zigbee2mqtt data directory";
      default = "/var/lib/zigbee2mqtt2";
      type = lib.types.path;
    };
  ...
  config = lib.mkIf (cfg.enable) {
    ...
    services.zigbee2mqtt2.settings = {
